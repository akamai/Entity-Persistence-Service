 ...
 */
public class SelectEntitiesByUriRegexTest extends BaseEntityQueryTestCase {
    ...
    /*public void testQuery() throws Exception {
        ...
        // now try finding those that start with the PARTITION prefix
        EntityResultSetProcessor processor = new EntityResultSetProcessor();
        helper.select(new SelectEntitiesByUriRegex("/" + EntityCreator.TYPE + ".*", true),
                processor);
